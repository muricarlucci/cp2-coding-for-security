...
def main():
    con = mysql_conexao(); cur = con.cursor(dictionary=True)
    ...
    cur.execute("DELETE FROM alertas"); cur.execute("DELETE FROM ativos")
    ...
    cur.executemany("INSERT INTO alertas (id,ativo_id,tipo,severidade,criado_em) VALUES (%s,%s,%s,%s,NOW())", [(1,1,"BRUTE_FORCE","critica"),(2,1,"PORT_SCAN","alta"),(3,2,"XSS","media")]); con.commit()
    ...
    mysql_total = len(docs); mongo_total = colecao.count_documents({})
